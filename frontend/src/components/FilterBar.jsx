...
const FilterBar = ({ filters, setFilters }) => {
  ...
  // Handle price range changes — only update local state while dragging
  ...
  // Commit price to parent only when the user releases the slider
  ...
  // Handle square footage range changes — only update local state while dragging
  ...
  // Commit sqft to parent only when the user releases the slider
  const commitSqftRange = () => {
    setFilters({
      ...filters,
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onPointerUp={commitSqftRange}
                    onTouchEnd={commitSqftRange}
                    className="w-full h-2 rounded-lg appearance-none cursor-pointer bg-gray-200"
                  />
                </div>
                <div>
